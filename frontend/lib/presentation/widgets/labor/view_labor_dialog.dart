    ...
    return _buildInfoCard(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: context.smallPadding),
          _buildInfoRow(l10n.totalAdvances, 'PKR ${widget.labor.totalAdvancesAmount.toStringAsFixed(2)}', Icons.payment),
          SizedBox(height: context.smallPadding),
          _buildInfoRow(l10n.remainingMonthlySalary, 'PKR ${widget.labor.remainingAdvanceAmount.toStringAsFixed(2)}', Icons.account_balance_wallet),
        ],
      ),
    );
  }
