...
class _AddVendorDialogState extends State<AddVendorDialog> with SingleTickerProviderStateMixin {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            PremiumTextField(
              label: 'Name',
              hint: isCompact ? 'Enter name' : 'Enter vendor name',
            ...
            PremiumTextField(
              label: 'Business Name',
              hint: isCompact ? 'Enter business name' : 'Enter business/shop name',
