...
class ProductService {
  ...
  Future<ApiResponse<Map<String, dynamic>>> bulkUpdateQuantities({required List<QuantityUpdateItem> updates}) async {
    try {
      ...
      return ApiResponse<Map<String, dynamic>>(success: false, message: 'An unexpected error occurred during bulk update');
    }
  }
  ...
  Future<ApiResponse<Product>> duplicateProduct({required String productId, String? newName}) async {
    try {
      ...
      return ApiResponse<Product>(success: false, message: 'An unexpected error occurred while duplicating product');
    }
  }
